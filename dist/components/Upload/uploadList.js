...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "ly-upload-list" }, fileList.map(function (item) { return (React.createElement("li", { className: "ly-upload-list-item", key: item.uid },
